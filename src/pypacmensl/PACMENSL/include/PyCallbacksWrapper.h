...
extern "C" int call_py_constr_obj(PyObject*, int, int, int, int*, int*, void*);
extern "C" int call_py_prop_obj(PyObject*, const int reaction, const int num_species, const int num_states, const int* states, double* outputs, void* args);
extern "C" int call_py_t_fun_obj (PyObject* object, double t, int num_coefs, double* outputs, void* args);
